...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('mjpeg-port', {
      describe: 'The WDA MJPEG server port in mac.'
    , type: 'number'
    , default: 9100
    })
    .option('wda-remote-port', {
      describe: 'The WDA Server port on device'
    , type: 'string'
    , default: 8100
    })
    .option('wda-mjpeg-remote-port', {
...
module.exports.handler = function(argv) {
  ...
  , wdaRemotePort: argv.wdaRemotePort
  , wdaMjpegRemotePort: argv.wdaMjpegRemotePort
